...
echo -e "${GREEN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "  ${YELLOW}${BOLD}🚀 FINAL CRITICAL STEPS:${NC}"
echo -e "  macOS security requires you to manually grant permissions:"
echo ""
echo -e "  1. ${BOLD}Accessibility:${NC} (Required for Autopaste)"
echo -e "     Set: ${BLUE}System Settings -> Privacy & Security -> Accessibility -> Hammerspoon (ON)${NC}"
echo -e "     Tip: If already ON but failing, toggle it OFF and then ON again to refresh.${NC}"
echo ""
echo -e "  2. ${BOLD}Microphone:${NC} (Required for Recording)"
echo -e "     Set: ${BLUE}System Settings -> Privacy & Security -> Microphone -> Hammerspoon (ON)${NC}"
echo ""
echo -e "  3. ${BOLD}Launch Hammerspoon:${NC}"
echo -e "     Open it from Applications and click ${BOLD}'Reload Config'${NC} in the menu bar."
echo ""
echo -e "  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "  ${YELLOW}Current Model:${NC} $ACTIVE_MODEL"
echo -e "  Hold ${BOLD}⌥D (Option+D)${NC} from any app to dictate!"
echo ""
